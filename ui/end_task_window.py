from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QLabel, QVBoxLayout, QHBoxLayout, QWidget, QLabel, QLineEdit, QSizePolicy, QMessageBox
...
class EndTaskWindow(QMainWindow):
    def __init__(self, name_of_worker):
        ...
        end_task_button.setStyleSheet("font-size: 50px;")
        end_task_button.clicked.connect(self.end_task_button_clicked)
        main_layout.addWidget(end_task_button)
    ...
    def end_task_button_clicked(self):
        ...
        for row, amount in self.task_inputs:
            ws.cell(row = row, column = 8, value = amount.text())
